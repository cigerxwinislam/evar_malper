    ...
    <Container className={styles.note}>
      <Container flex={1}>
        <p>
          ...
          <span className={styles.link}>{user.email}</span>) doğrulandı.
        </p>
      </Container>
  ...
  const onSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        toast.success('Profiliniz doğrulandı ');
      } catch (e) {
        toast.error(e.message);
      } finally {
        setIsLoading(false);
